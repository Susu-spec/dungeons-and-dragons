      ...
      <AnimatePresence>
        {open && (
          <div className=" w-full h-full mx-auto max-h-[10.5rem] md:max-h-[20.5rem] md:max-w-[30rem]">
            <motion.div
              className="fixed inset-x-auto inset-y-0 md:inset-x-[30%] md:inset-y-[20%] md:!pt-0 w-full h-full bg-transparent mx-auto max-h-[35rem] md:max-h-[40.5rem] md:max-w-[30rem] z-50"
