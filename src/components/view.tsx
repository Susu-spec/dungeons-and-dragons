    ...
    return (
        <div className="w-full h-full relative">
            <button className="cursor-pointer" onClick={() => setOpen(true)}>
                ...
                {open && 
                <div className="fixed inset-0 w-full h-full bg-opacity-50 z-50" 
                    onClick={() => {
                ...
                {open && 
               <div
                className=" w-full h-full mx-auto md:max-h-[20.5rem] md:max-w-[30rem]">
                  <motion.div
                    className="fixed inset-x-[30%] inset-y-[40%]  md:!pt-0 w-full h-full mx-auto md:max-h-[20.5rem] md:max-w-[30rem] z-50"
